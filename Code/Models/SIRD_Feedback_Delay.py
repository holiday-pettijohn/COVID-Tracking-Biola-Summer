...
def predictFuture(S,I,R,D, daysToPredict, linVars=None, nonLinVars=None, graphVals=[False,True,True,True], graph=True):
...
def predictMatch(S,I,R,D, daysToPredict, linVars=None, nonLinVars=None, graphVals=[False,True,True,True], graph=True):
